...
internal class AddEnrollmentCommandHandler : IRequestHandler<AddStudentCommand>
{
    private readonly IStudentRepository _studentRepository;
    private readonly IUnitOfWork _unitOfWork;

    public AddEnrollmentCommandHandler(IStudentRepository studentRepository, IUnitOfWork unitOfWork)
    {
